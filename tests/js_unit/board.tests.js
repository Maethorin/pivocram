        ...
        describe('loading stories', function() {
            ...
            it('should define dev days if in same month', function() {
                ...
                expect($scope.devDays).toEqual([
                    { id: 24, day: '25/04', points: 1.8, passed: true, isToday: false },
                    { id: 25, day: '26/04', points: 1.8, passed: true, isToday: false },
                    { id: 26, day: '27/04', points: 1.8, passed: false, isToday: true },
                    { id: 27, day: '28/04', points: 1.8, passed: false, isToday: false },
                    { id: 28, day: '29/04', points: 1.8, passed: false, isToday: false },
                    { id: 31, day: '02/05', points: 1.8, passed: false, isToday: false },
                    { id: 32, day: '03/05', points: 1.8, passed: false, isToday: false },
                    { id: 33, day: '04/05', points: 1.8, passed: false, isToday: false },
                    { id: 34, day: '05/05', points: 1.8, passed: false, isToday: false },
                    { id: 35, day: '06/05', points: 1.8, passed: false, isToday: false }
                ]);
            });
            it('should define dev days if in different month', function() {
                ...
                expect($scope.devDays).toEqual([
                    { id: 24, day: '25/04', points: 1.8, passed: true, isToday: false },
                    { id: 25, day: '26/04', points: 1.8, passed: true, isToday: false },
                    { id: 26, day: '27/04', points: 1.8, passed: true, isToday: false },
                    { id: 27, day: '28/04', points: 1.8, passed: true, isToday: false },
                    { id: 28, day: '29/04', points: 1.8, passed: true, isToday: false },
                    { id: 31, day: '02/05', points: 1.8, passed: false, isToday: false },
                    { id: 32, day: '03/05', points: 1.8, passed: false, isToday: false },
                    { id: 33, day: '04/05', points: 1.8, passed: false, isToday: false },
                    { id: 34, day: '05/05', points: 1.8, passed: false, isToday: false },
